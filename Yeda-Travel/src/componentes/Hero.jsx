  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl px-6">
        <h1 className="text-4xl md:text-6xl font-bold text-[#fefefe]">
        ...
        <Link
          to="/destinos"
          className="mt-6 inline-block bg-[#2cbfcf] text-[#fefefe] px-6 py-3 rounded-lg text-lg font-semibold hover:bg-[#238b94] transition"
        >
          Explorar Destinos
        </Link>
      </div>
